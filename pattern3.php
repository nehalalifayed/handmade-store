...
$db = mysqli_connect("localhost","root","","store");
        ...
        $comment="";
$query5=false;
    $sql5= "SELECT * FROM visitor_review Where PID='3'";
...
{
	$query=false;
    $sql= "SELECT * FROM visitor_review Where PID='3' AND visname='$name' ";
...
if( $error==false)
    {
      ...
      $query=false;
    $sql= "INSERT INTO visitor_review ( visname,PID,review) Values('$name','3','$comment')";
    $result = mysqli_query($db, $sql);
...
<br>
        ...
        <div class="about-section">
		 ...
		 <img src="<?php echo $img[10]; ?>" alt="">
          ...
          <div class="col-sm-5">
           <div class="row">
              <form method="post" action= "pattern3.php">
