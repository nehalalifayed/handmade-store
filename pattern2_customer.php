...
$query5=false;
    $sql5= "SELECT * FROM customer_review Where PID='2'";
...
{
	$query=false;
    $sql= "SELECT * FROM customer_review Where PID='2' AND AID= $aid ";
    $result = mysqli_query($db, $sql);
...
if( $error==false)
{
	 $link ="your registration is successful !!"; 
      $query=false;
    $sql= "INSERT INTO customer_review ( review,PID,AID) Values('$comment','2','$aid')";
    $result = mysqli_query($db, $sql);
...
$sql = "SELECT * FROM free_pattern Where PID = '2'";
$result = mysqli_query($db,$sql);
...
$img = array();
$Sql = "SELECT * FROM pattern_image Where PID = '2'";
...
<!---------------------------------------------------------------------------->
  ...
  <div class="col-sm-7">
     ...
     <div class="about-text">
      <p> <?php echo $arr[0]; ?><br> <?php echo $arr[1]; ?></p>
     </div> 
      <div class="clearfix"></div>  
        </div>
<br>
     ...
     <div class="about-text">
      <p><?php echo $arr[2]; ?><br><?php echo $arr[3]; ?></p>
     </div> 
          </div>
      <div class="clearfix"></div>  
     ...
     <div class="about-text">
      <p><?php echo $arr[4]; ?><br> <?php echo $arr[5]; ?><br><?php echo $arr[6]; ?></p>
     </div> 
          </div>
      <div class="clearfix"></div>
     ...
     <div class="about-text">
      <p><?php echo $arr[7]; ?><br><?php echo $arr[8]; ?><br><?php echo $arr[9]; ?></p>
     </div> 
          </div>
      <div class="clearfix"></div>
                  <br>
     ...
     <div class="about-text">
             <p><?php echo $arr[10]; ?> <br><?php echo $arr[11]; ?>.
                 <br>
<?php echo $arr[12]; ?><br> <?php echo $arr[13]; ?>
                 <br>
<?php echo $arr[14]; ?><br> <?php echo $arr[15]; ?><?php echo $arr[16]; ?>
                 <br>
<?php echo $arr[17]; ?> <br><?php echo $arr[18]; ?>
                 <br>
<?php echo $arr[19]; ?>
                 <br>
<?php echo $arr[20]; ?></p>
      ...
      <div class="clearfix"></div>
          ...
          <div class="col-sm-5">
           <div class="row">
 <form method="post" action= "pattern2_customer.php">
