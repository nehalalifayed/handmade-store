...
$na="";
$query5=false;
    $sql5= "SELECT * FROM customer_review Where PID='1'";
...
{
	$query=false;
    $sql= "SELECT * FROM customer_review Where PID='1' AND AID= $aid ";
    $result = mysqli_query($db, $sql);
...
if( $error==false)
{
	 $link ="your registration is successful !!"; 
      $query=false;
    $sql= "INSERT INTO customer_review ( review,PID,AID) Values('$comment','1','$aid')";
    $result = mysqli_query($db, $sql);
...
<br>
   ...
   <form method="post" action= "pattern1_customer.php">
