...
$query5=false;
    $sql5= "SELECT * FROM visitor_review Where PID='2'";
...
{
	$query=false;
    $sql= "SELECT * FROM visitor_review Where PID='2' AND visname='$name' ";
...
if( $error==false)
    {
      ...
      $query=false;
    $sql= "INSERT INTO visitor_review ( visname,PID,review) Values('$name','2','$comment')";
    $result = mysqli_query($db, $sql);
