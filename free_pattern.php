	 ...
	 <div class="container">
		 <div class="header-left">
			 <div class="top-menu">
				 ...
				 <li class="active"><a href="free_pattern.php">FREE PATTERN</a></li>			 
				 </ul>
			 </div>
		 </div>
		 <div class="logo">
			 ...
			 <div class="fashion-section">
				 <div class="fashion-grid1">
					 <div class="col-md-4 fashion-grid">
						 <a href="pattern1.html"><img src="images/pattern/1/main1a.jpg" alt=""/>
							 <div class="product">
								 <h3>Owl Amigurumi</h3>
							 </div>							 
						 </a>
						 <div class="fashion-view"><span></span>
									<div class="clearfix"></div>
								 <h4><a href="pattern1.php">View</a></h4>
						 </div>
					 </div>
					 <div class="col-md-4 fashion-grid">
						 <a href="pattern2.html"><img src="images/pattern/2/main4web.jpg" alt=""/>
							 <div class="product">
						 ...
						 <div class="fashion-view"><span></span>
									<div class="clearfix"></div>
								 <h4><a href="pattern2.php">View</a></h4>
						 </div>
					 </div>
					 <div class="col-md-4 fashion-grid">
						 <a href="pattern3.html"><img src="images/pattern/3/main.jpg" alt=""/>
							 <div class="product">
						 ...
						 <div class="fashion-view"><span></span>
									<div class="clearfix"></div>
								 <h4><a href="pattern3.php">View</a></h4>
						 </div>
					 </div>
					 <div class="clearfix"></div>
				 </div>
