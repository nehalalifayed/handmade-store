...
<div class="men-fashions">
	 <div class="container">
			  ...
			  <div class="categories">
					<h3>CATEGORIES</h3>
				  <ul>
						<li><a href="scarves_visitor.php">scarves</a></li>
						<li><a href="shawl_visitor.php">cowls and shawls</a></li>
						<li><a href="hat_visitor.php">hats</a></li>
						<li><a href="sweat_visitor.php">sweaters</a></li>
						<li><a href="blankets_visitor.php">blankets</a></li>
						<li><a href="amugrumi_visitor.php">amugrumi</a></li>
						<li><a href="yarn_visitor.php">Yarn</a></li>
				  </ul>
			  </div>
